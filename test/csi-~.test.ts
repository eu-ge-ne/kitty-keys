...
Deno.test("HOME", () => {
  ...
  is("\x1b[7~", { key, event: "press" });

  is("\x1b[7;5~", { key, event: "press", ctrl: true });
  is("\x1b[7;3~", { key, event: "press", alt: true });
  is("\x1b[7;2~", { key, event: "press", shift: true });
  is("\x1b[7;65~", { key, event: "press", caps_lock: true });

  is("\x1b[7;1:1~", { key, event: "press" });
...
Deno.test("END", () => {
  ...
  is("\x1b[8~", { key, event: "press" });

  is("\x1b[8;5~", { key, event: "press", ctrl: true });
  is("\x1b[8;3~", { key, event: "press", alt: true });
  is("\x1b[8;2~", { key, event: "press", shift: true });
  is("\x1b[8;65~", { key, event: "press", caps_lock: true });

  is("\x1b[8;1:1~", { key, event: "press" });
...
Deno.test("F1", () => {
  ...
  is("\x1b[11~", { key, event: "press" });

  is("\x1b[11;5~", { key, event: "press", ctrl: true });
  is("\x1b[11;3~", { key, event: "press", alt: true });
  is("\x1b[11;2~", { key, event: "press", shift: true });
  is("\x1b[11;65~", { key, event: "press", caps_lock: true });

  is("\x1b[11;1:1~", { key, event: "press" });
...
Deno.test("F2", () => {
  ...
  is("\x1b[12~", { key, event: "press" });

  is("\x1b[12;5~", { key, event: "press", ctrl: true });
  is("\x1b[12;3~", { key, event: "press", alt: true });
  is("\x1b[12;2~", { key, event: "press", shift: true });
  is("\x1b[12;65~", { key, event: "press", caps_lock: true });

  is("\x1b[12;1:1~", { key, event: "press" });
...
Deno.test("F3", () => {
  ...
  is("\x1b[13~", { key, event: "press" });

  is("\x1b[13;5~", { key, event: "press", ctrl: true });
  is("\x1b[13;3~", { key, event: "press", alt: true });
  is("\x1b[13;2~", { key, event: "press", shift: true });
  is("\x1b[13;65~", { key, event: "press", caps_lock: true });

  is("\x1b[13;1:1~", { key, event: "press" });
...
Deno.test("F4", () => {
  ...
  is("\x1b[14~", { key, event: "press" });

  is("\x1b[14;5~", { key, event: "press", ctrl: true });
  is("\x1b[14;3~", { key, event: "press", alt: true });
  is("\x1b[14;2~", { key, event: "press", shift: true });
  is("\x1b[14;65~", { key, event: "press", caps_lock: true });

  is("\x1b[14;1:1~", { key, event: "press" });
...
Deno.test("F5", () => {
  ...
  is("\x1b[15~", { key, event: "press" });

  is("\x1b[15;5~", { key, event: "press", ctrl: true });
  is("\x1b[15;3~", { key, event: "press", alt: true });
  is("\x1b[15;2~", { key, event: "press", shift: true });
  is("\x1b[15;65~", { key, event: "press", caps_lock: true });

  is("\x1b[15;1:1~", { key, event: "press" });
...
Deno.test("F6", () => {
  ...
  is("\x1b[17~", { key, event: "press" });

  is("\x1b[17;5~", { key, event: "press", ctrl: true });
  is("\x1b[17;3~", { key, event: "press", alt: true });
  is("\x1b[17;2~", { key, event: "press", shift: true });
  is("\x1b[17;65~", { key, event: "press", caps_lock: true });

  is("\x1b[17;1:1~", { key, event: "press" });
